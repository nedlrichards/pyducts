program ram
    use ram_v4 ,only      : updat, solve, selfs, pe_pade, matrc
    ...
    call inram(mr,mz,nz,mp,np,ns,ndr,ndz,iz,nzplt,lz,ir,dir,dr,dz,omega,rmax,  &
               c0,k0,rp,rs,rb,zb,rhob,alpw,alpb,ksqw,ksqb,zs,zr,zmax,zmplt)
    ...
    ! self starter and initialize pe propagator
